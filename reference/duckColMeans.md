...
- features:
  ...
  Features to be included to calculate column mean, used to subset raw
  data

- cells:

  Cells to be included to calculate column mean, used to subset raw data
