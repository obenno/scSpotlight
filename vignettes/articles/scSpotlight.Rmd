...
gene UMI distribution and ribosomal protein gene UMI distribution in VlnPlot panel. One could
inspect the results to roughly evaluate the library quality.
